...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/YYYY-MM-DD_HH-MM-SS-XXXX_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. `13-00-00` for `1:00:00 pm`)
        - XXXX is the ticket identifier (e.g. `ENG-2166`; use `general` for ad-hoc work with no ticket)
        - description is a brief kebab-case summary of the handoff
    - Run the `bin/metadata.sh` script to generate all relevant metadata
    - Examples:
        - With ticket: `2025-01-08_13-55-22-ENG-2166_create-context-compaction.md`
        - Without ticket: `2025-01-08_13-55-22-general_create-context-compaction.md`
...
### 3. Approve and Sync
Ensure the handoff file is saved and available for the next session.
...
```bash
/resume_handoff thoughts/shared/handoffs/2025-01-08_13-44-55-ENG-2166_create-context-compaction.md
```
</example_response>
